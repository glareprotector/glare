...
side_effect_name = 'incontinence_test'
side_effect_series_attribute = global_stuff.get_tumor_cls().incontinence_time_series
...
class mean_interval_vals(bf.feature):
    ...
    def _generate(self, data_set):
        ...
        labeler = bf.single_ordinal_single_value_wrapper_feature(af.get_bucket_label_feature())
...
g = mean_interval_vals(side_effect_series_attribute, intervals)
...
plot_structs = []
plot_structs.append(plotters.plot_struct(lambda x: True, 'all', g))

for plot_struct in plot_structs:
    plotters.plot_time_series(treated_data_set, plot_struct.filtering_f, plot_struct.label, plot_struct.g)

plt.legend(loc = 'lower_center')
title = side_effect_name + '_' + 'all_treated_support'
plt.title(title)
plt.savefig(title + '.png')
...
plot_structs = []
plot_structs.append(plotters.plot_struct(lambda x: f.pre_treatment_side_effect_label_f(side_effect_instance).generate(x) == 1, 'pre_good', g, 'c'))
plot_structs.append(plotters.plot_struct(lambda x: f.pre_treatment_side_effect_label_f(side_effect_instance).generate(x) == 0, 'pre_bad', g, 'r'))
...
plot_structs.append(plotters.plot_struct(lambda x: f.pre_treatment_side_effect_label_f(side_effect_instance).generate(x) == 1, 'pre_good', g))
plot_structs.append(plotters.plot_struct(lambda x: f.pre_treatment_side_effect_label_f(side_effect_instance).generate(x) == 0, 'pre_bad', g))

for plot_struct in plot_structs:
    plotters.plot_time_series(treated_data_set, plot_struct.filtering_f, plot_struct.label, plot_struct.g)

plt.legend(loc = 'lower_center')
title = side_effect_name + '_' + 'all_treated_by_pre_treatment_state_support'
plt.title(title)
plt.savefig(title + '.png')
...
plot_structs.append(plotters.plot_struct(lambda x: f.treatment_code_f().generate(x) == 2, 'RAD', g))
plot_structs.append(plotters.plot_struct(lambda x: f.treatment_code_f().generate(x) == 1, 'SURG', g))

for plot_struct in plot_structs:
    plotters.plot_time_series(treated_data_set, plot_struct.filtering_f, plot_struct.label, plot_struct.g)

plt.legend(loc = 'lower_center')
title = side_effect_name + '_' + 'all_treated_by_treatment_support'
plt.title(title)
plt.savefig(title + '.png')
...
plot_structs = []
plot_structs.append(plotters.plot_struct(lambda x: f.pre_treatment_side_effect_label_f(side_effect_instance).generate(x) == 1 and f.treatment_code_f().generate(x) == 2, 'RAD', g, 'c'))
plot_structs.append(plotters.plot_struct(lambda x: f.pre_treatment_side_effect_label_f(side_effect_instance).generate(x) == 1 and f.treatment_code_f().generate(x) == 1, 'SURG', g, 'r'))
...
plot_structs = []
plot_structs.append(plotters.plot_struct(lambda x: f.pre_treatment_side_effect_label_f(side_effect_instance).generate(x) == 0 and f.treatment_code_f().generate(x) == 2, 'RAD', g, 'c'))
plot_structs.append(plotters.plot_struct(lambda x: f.pre_treatment_side_effect_label_f(side_effect_instance).generate(x) == 0 and f.treatment_code_f().generate(x) == 1, 'SURG', g, 'r'))
