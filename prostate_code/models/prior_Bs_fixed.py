def get_prior_model_manager(cov, b_a, b_b, b_c, the_pid):
    """
    ...
    num_attributes = len(x)


    M.constants.sigma_a_max = 100
    M.constants.mu_pop_a = 0.5
    ...
    M.set_pid_variaoble_value_blanket('b', 0.5)
    ...
    M.set_pid_variable_value('cov', the_pid, x)
