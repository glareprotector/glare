...
class fragment_getter_by_delim(fragment_getter):
    ...
    def get_fragment(self, text, position):
        ...
        while delimiter_m.search(raw_text[local_end]) == None:
            local_end += 1
            print raw_text[local_end]

        while delimiter_m.search(raw_text[local_start]) == None:
            local_start -= 1
            print raw_text[local_start]
...
class fragment_getter_by_stuff_after_colon(fragment_getter):
    ...
    def get_fragment(self, text, position):
        ...
        current_line = current_line_getter.get_fragment(position)
        ...
        if m == None:
            ...
            if m == None:
                ...
                return fragment(text, colon_pos + current_line.get_abs_start(), m.start() + current_line.get_abs_start())
